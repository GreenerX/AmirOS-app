...
- People is the primary relationship directory. It reuses the existing Intelligence data to show contact cards and a Contact Intelligence detail view without changing backend analysis or approval flows.
